# 식품안전정보원(NFSI) 인턴십 분석 보고서

식품안전정보원 인턴십 기간 동안 수행한 데이터 분석 및 AI 프로젝트 보고서를 정리한 저장소입니다.
머신러닝 기반 예측 모델 구축, 텍스트마이닝, 유전정보 분류, 서비스 기획 등 공공 데이터 활용 프로젝트를 포함하고 있습니다.

※ 기관 보안 정책상 원천 데이터 및 전체 코드는 제외하고 보고서 중심으로 공개합니다.
